...
class DIALOG_DESIGN_RULES_BASE : public DIALOG_SHIM
{
	...
	public:
		...
		DIALOG_DESIGN_RULES_BASE( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Design Rules Editor"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 894,611 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER ); 
